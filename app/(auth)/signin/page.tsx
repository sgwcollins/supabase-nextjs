...
export default function SignIn() {
  ...
  const { signInWithEmail, signInWithGithub,signInWithGoogle, user } = useAuth();
           ...
           <form onSubmit={handleSubmit}>
              ...
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  ...
                  <input type="password" name="password"onChange={(e) => setPassword(e.target.value)} value={password} id="password" className="form-input w-full text-gray-800" placeholder="Enter your password" required />
                </div>
              </div>
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
              ...
              <div className="flex flex-wrap -mx-3 mt-6">
                <div className="w-full px-3">
                  <button type="button" className="btn text-white bg-blue-600 hover:bg-blue-700 w-full">Sign in</button>
                </div>
              </div>
            </form>
            ...
            <form>
              <div className="flex flex-wrap -mx-3 mb-3">
                <div className="w-full px-3">
                  <button onClick={signInWithGithub} className="btn px-0 text-white bg-gray-900 hover:bg-gray-800 w-full relative flex items-center">
